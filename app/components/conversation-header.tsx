...
export default function ConversationHeader({ 
  ...
  if (!conversationId) {
    return (
      <div className="h-16 bg-surface-elevated border-b border-theme flex items-center px-6">
        <div className="flex-1 text-center">
          <h3 className="font-semibold text-primary">Aether Meet</h3>
          <p className="text-sm text-secondary">Sélectionnez une conversation</p>
        </div>
      </div>
    );
  }
